...
describe("UIIntegrationTest", function () { // TODO: Rename to Piwik?
    ...
    it('should load the goals > ecommerce page correctly', async function () {
        ...
        expect(await page.screenshotSelector('.pageWrap,.dataTable')).to.matchImage('goals_ecommerce');
    });
    ...
    it('should load the goals > overview page correctly', async function () {
        ...
        expect(await page.screenshotSelector('.pageWrap,.dataTable')).to.matchImage('goals_overview');
    });
    ...
    it('should load the goals > single goal page correctly', async function () {
        ...
        expect(await page.screenshotSelector('.pageWrap,.dataTable')).to.matchImage('goals_individual_goal');
    });
